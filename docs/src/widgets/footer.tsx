    ...
    <footer className="border-t border-slate-200 pt-8 dark:border-slate-800">
      <div className="flex flex-col items-center justify-center md:flex-row md:justify-between">
        <div className="mb-4 md:mb-0">
          <div className="flex shrink-0 flex-col items-center md:flex-row">
            ...
            <div className="ml-4 text-sm text-slate-500">
              Copyright © Ahn Co<span className="md:hidden lg:inline">. All rights reserved.</span>
            </div>
          </div>
        </div>
        {/* Social links */}
        <ul className="inline-flex space-x-2">
          <li>
            <a
              className="flex items-center justify-center text-blue-500 transition duration-150 ease-in-out hover:text-blue-600"
              href="#0"
              aria-label="Twitter"
              target="_blank"
            >
