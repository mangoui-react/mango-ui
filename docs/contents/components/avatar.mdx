...
<ImportSyntax
  command={{
    individual: `import { AvatarRoot, AvatarImg, AvatarGroup, AvatarGroupContent, AvatarExtra } from '@melio-ui/alert';`,
    global: `import { AvatarRoot, AvatarImg, AvatarGroup, AvatarGroupContent, AvatarExtra } from '@melio-ui/react';`,
  }}
/>
