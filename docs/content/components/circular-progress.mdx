...
<PackageManagers
  command={{
    npm: 'npm i @mangoui/circular-progress',
    yarn: 'yarn add @mangoui/circular-progress',
    pnpm: 'pnpm add @mangoui/circular-progress',
    bun: 'bun add @mangoui/circular-progress',
  }}
/>
...
import { CircularProgress } from '@mangoui/circular-progress';
