...
<PackageManagers
  command={{
    npm: 'npm i @mangoui/checkbox',
    yarn: 'yarn add @mangoui/checkbox',
    pnpm: 'pnpm add @mangoui/checkbox',
    bun: 'bun add @mangoui/checkbox',
  }}
/>
...
import { Checkbox } from '@mangoui/checkbox';
