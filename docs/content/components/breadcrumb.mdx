...
<PackageManagers
  command={{
    npm: 'npm i @mangoui/breadcrumb',
    yarn: 'yarn add @mangoui/breadcrumb',
    pnpm: 'pnpm add @mangoui/breadcrumb',
    bun: 'bun add @mangoui/breadcrumb',
  }}
/>
...
import { Breadcrumb } from '@mangoui/breadcrumb';
