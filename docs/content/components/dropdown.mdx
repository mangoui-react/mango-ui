...
<PropsTable
  data={[
    ...
    },
    {
      ...
      required: false,
      type: 'number',
      description: 'A property that controls the stacking order of elements on a web page.(CSS z-index)',
    },
    {
      name: 'destroyOnClose',
      required: false,
  ...
  <Dropdown.Portal>
    <Dropdown.Content>
      <div style={{ padding: '0.625rem 0.3125rem' }}>
        <div style={{ paddingLeft: '0.3125rem', paddingBottom: '0.5rem' }}>제목1</div>
        <Dropdown.Item>DropdownItem - 1</Dropdown.Item>
        <Dropdown.Item>DropdownItem - 2</Dropdown.Item>
        <Dropdown.Item>DropdownItem - 3</Dropdown.Item>
      </div>
      <div style={{ padding: '0.625rem 0.3125rem' }}>
        <div style={{ paddingLeft: '0.3125rem', paddingBottom: '0.5rem' }}>제목2</div>
        <Dropdown.Item>DropdownItem - 4</Dropdown.Item>
        <Dropdown.Item>DropdownItem - 5</Dropdown.Item>
        <Dropdown.Item>DropdownItem - 6</Dropdown.Item>
      </div>
    </Dropdown.Content>
  </Dropdown.Portal>
</Dropdown.Root>
