...
<PackageManagers
  command={{
    npm: 'npm i @mangoui/number-input',
    yarn: 'yarn add @mangoui/number-input',
    pnpm: 'pnpm add @mangoui/number-input',
    bun: 'bun add @mangoui/number-input',
  }}
/>
...
import { NumberInput } from '@mangoui/number-input';
